...
/home/oacis/oacis/bin/oacis_cli create_parameter_sets -s ${SIML} -i '{"MAP":"'${MAP}'","F":"'${F}'","P":"'${P}'","A":"'${A}'"}' -r '{"num_runs":1,"mpi_procs":0,"omp_threads":0,"priority":1,"submitted_to":"'${HOST}'","host_parameters":null}' -o ps.json

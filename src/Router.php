...
class Router
{
	function routing()
	{
		...
		else
        {
            ...
            $router->controller('/settings-restrict', 'adf\\controller\\SettingsRestrictAccessController');
            $router->controller('/settings-restrict_set', 'adf\\controller\\SettingsRestrictAccessSetController');
            $router->controller('/settings-restrict_set_unrestrected', 'adf\\controller\\SettingsRestrictAccessHostsController');

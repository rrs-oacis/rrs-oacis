...
<header class="main-header">
  <!-- Logo -->
  <a href="./index.php" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini"><?= Config::APP_MIN_NAME?></span> <!-- logo for regular state and mobile devices -->

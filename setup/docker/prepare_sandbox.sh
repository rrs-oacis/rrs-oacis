...
docker create --name rrsoacis_sandbox -p 3080:3080 -p 3000:3000 -p 49138:49138/udp -v `pwd`:/home/oacis/rrs-oacis -v `pwd`/rrsoacis-init.sh:/etc/rrsoacis-init.sh -t rrsoacis/rrsoacis

...
<div class="box box-primary">
  ...
  <!-- /.box-header -->
  <!-- form start -->
  <form id="add_parameter-form" action="./manual_post-add_parameter" method="POST"
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">Simulator ID</label>
      ...
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">Host ID</label>
...
$(".readonly").keydown(function(e){
  ...
  $("#add_parameter-form").submit(function(e){
		...
		fetch('./manual_post-add_parameter', {

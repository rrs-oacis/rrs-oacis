...
<div class="box box-info">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="./map_upload" method="POST"
          class="form-horizontal add-map-form" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Name</label>

                <div class="col-sm-10">
                    <input type="text" class="form-control a-title" name="map_name"
                           id="inputTitle-1"
...
<div id="add_map_form_area" class="col-sm-12 col-md-6">
...
<script>
    ...
    $(function(){
        ...
        var dropZone = document.getElementById('add_map_form_area');
        ...
        addAll.addEventListener("click",function () {
            ...
            var forms = document.getElementsByClassName("add-map-form");
    ...
    function initForm(file){
        ...
        var t = document.querySelector('#map_form_template');
        ...
        var addF = document.querySelector('#add_map_form_area');
